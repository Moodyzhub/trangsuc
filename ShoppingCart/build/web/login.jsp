                        ...
                        <div class="signin-form">
                            ...
                            <form action="user-login" method="post" class="register-form" id="login-form">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="login-email" value="" id="email" placeholder="Your Email"required>
                                </div>
                                <div class="form-group">
                                    <label for="pass"><i class="zmdi zmdi-lock"></i></label>
                                    <input type="password" name="login-password" value="" id="pass" placeholder="Password" required>
                                </div>
