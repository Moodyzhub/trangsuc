...
<html>
    <head>
        ...
        <link rel="icon" href="images/order.png"
              type="images/x-icon"/>
        <style>
            body {
                background: #ebedf2;
            ...
            /* CSS để làm cho nút button đẹp hơn */
            .shop-now-button {
                background-color: #ff5f6d; /* Màu nền của nút */
            ...
            .shop-now-button:hover {
                background-color: #ff7b87; /* Màu nền thay đổi khi di chuột qua */
            }
            ...
            .shop-now-button a {
                ...
                color: #007bff; /* Đặt màu chữ thành xanh dương */
            }
    ...
    <body>
        ...
        <div class="container">
            ...
            <table class="table table-light">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><%=o.getName() %></td>
                        <td><%=o.getGia()%></td>
                        <td><%=o.getCate().getCname()%></td>
                        <td><%=o.getQuantity() %></td>
                        <td><%=dcf.format(o.getPrice()) %> <span>$</span></td>
            ...
            <div class="empty-state">
                <div class="empty-state__content">
                    <div class="empty-state__icon">
                        <%--    <img src="data:image/png;base64," 
                             alt=""> --%>
                        <img src="images/passprj.png" alt="alt"/>
                    </div>
                ...
                <a href="home" class="btn btn-primary cart-btn-transform m-3" data-abc="true">go shopping now</a>
            </div>
            <% } %>
        </div>
