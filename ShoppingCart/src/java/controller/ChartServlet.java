...
// Iterate over the years from 2018 to 2024
        for (int year = 2018; year <= 2024; year++) {
            ...
            yearData.put(year, totalMoney);
        }

// Set the year data as attributes in the request
        for (Map.Entry<Integer, Double> entry : yearData.entrySet()) {
            request.setAttribute("year" + entry.getKey(), entry.getValue());
        }
