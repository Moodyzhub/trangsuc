...
public class UpdateUserServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int  isSeller = Integer.parseInt(request.getParameter("role1"));
        int  isAdmin = Integer.parseInt(request.getParameter("role2"));
        User user = new User(id, name, email, pass, isSeller, isAdmin, country, contact);
